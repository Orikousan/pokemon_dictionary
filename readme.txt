...
◇ インストール ◇
	zipファイルを解凍してください。そしてこのsaisyuフォルダごとhtdocsフォルダの中に配置してください。

◇ アンインストール ◇
	展開してできたフォルダをまるごと削除すれば、アンインストール完了です。

◇ つかいかた ◇
	まずzipファイルを解凍して中にあるファイルやフォルダをそのままhtdocフォルダの真下に配置してください。次	に、初期化スクリプト.txtに従ってターミナルでユーザの作成、データベースの設計などを行なってください。そ	してそれらの作業が終わったらXAMPPを起動してCoocle ChromeなどのブラウザのURL欄に
